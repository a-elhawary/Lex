...
import { CalendarIcon, Plus, Edit2, Trash2, CheckCircle2, Circle } from "lucide-react";
  ...
  return (
    <div className="max-w-7xl mx-auto py-4 sm:py-6 px-3 sm:px-4 md:px-6">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-4 sm:mb-6 gap-4">
        <div>
          <h1 className="text-2xl sm:text-3xl font-bold text-foreground">Legal Tasks</h1>
        ...
        <Dialog open={showCreateModal} onOpenChange={setShowCreateModal}>
          ...
          <DialogContent className="max-w-2xl mx-3 sm:mx-4">
            <DialogHeader>
